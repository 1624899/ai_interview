...
## 个人简介
（3-5句话，分点描述，突出核心竞争力与目标职位的匹配度，要有说服力，允许适度包装：语言润色、合理的推断、基于行业标准估算的数据、突显亮点）
...
（技能模块要体现：专业深度 + 技术广度 + 与JD的匹配度， 但要注意保持真实性，避免过度包装/内容夸大，确保技能描述与实际经验相符）
