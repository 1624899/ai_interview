...
export const API_PROVIDERS = [
    ...
    { id: 'aiping', name: 'AI Ping（含限时免费模型） ', baseUrl: 'https://aiping.cn/api/v1', apiKeyUrl: 'https://www.aiping.cn/user/apikey', models: ['GLM-4.7', 'DeepSeek-V3.2', 'Qwen3-235B-A22B', 'MiMo-V2-Flash'] },
